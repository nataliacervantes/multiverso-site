            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="text-center order_complete">
                        ...
                        <h3>¡Tu orden está completa!</h3>
                        </div>
                        <p>¡Gracias por tu compra! Recibirás un correo electrónico con tu número de guía y comprobante de envío en las próximas horas.</p>
